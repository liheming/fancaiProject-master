package com.suctan.huigang.adapter.order.sellorder;
 ...
 */
public class SellDetailItemAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<WantEatFoodItem> wantEatItemList;

    public SellDetailItemAdapter(Context context, ArrayList<WantEatFoodItem> wantEatItemList) {
