package com.suctan.huigang.adapter.dofood;
 ...
 */
public class DoWantItemAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<WantEatFoodItem> wantEatItemList;

    public DoWantItemAdapter(Context context, ArrayList<WantEatFoodItem> wantEatItemList) {
