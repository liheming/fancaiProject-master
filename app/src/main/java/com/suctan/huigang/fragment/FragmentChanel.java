...
import com.suctan.huigang.activity.share.ServiceList;
import com.suctan.huigang.mvp.login.index.chanel.ChanelPresenter;
import com.suctan.huigang.mvp.login.index.chanel.ChanelView;
...
public class
FragmentChanel extends MvpFragment<ChanelPresenter> implements View.OnClickListener, ChanelView {
    //此处定义共享需求类型常量
