 ...
 */
public class TipsAddAddressDialog extends AlertDialog implements View.OnClickListener {
    ...
    public TipsAddAddressDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipdialog_comfirm.setText("添加");
        tipdialog_cancel = (Button) findViewById(R.id.tipdialog_cancel);
        tipdialog_content.setText("您还没有收获地址！");
        //监听点击事件
