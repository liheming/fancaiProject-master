 ...
 */
public class TipsCancelOrderDialog extends AlertDialog implements View.OnClickListener {
    ...
    public TipsCancelOrderDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipdialog_content.setText("确定取消该订单！");
        //监听点击事件
