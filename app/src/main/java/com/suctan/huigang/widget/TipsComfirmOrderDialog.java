 ...
 */
public class TipsComfirmOrderDialog extends AlertDialog implements View.OnClickListener {
    ...
    public TipsComfirmOrderDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipdialog_content.setText("您确定已收货！");
        //监听点击事件
