 ...
 */
public class TipsAddCartDialog extends AlertDialog implements View.OnClickListener {
    ...
    public TipsAddCartDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipdialog_comfirm.setText("查看");
        tipdialog_cancel = (Button) findViewById(R.id.tipdialog_cancel);
        tipdialog_content.setText("加入购物车成功！");
        //监听点击事件
