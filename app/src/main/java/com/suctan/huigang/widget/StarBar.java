...
public class StarBar extends LinearLayout {
    ...
    private int mStarChoose = 3;  //默认是三颗星
    ...
    public void setStarNum(int number) {
        ...
        for (int i = 0; i < number; i++) {
            ...
            Log.i(TAG, "setStarNum:  看真假"+canCheck);
            if (true) {
                Log.i(TAG, "setStarNum: 我是true");
    ...
    public void setDefaultImageId(int resouceId) {
        this.mDefaultImageId = resouceId;
    }
