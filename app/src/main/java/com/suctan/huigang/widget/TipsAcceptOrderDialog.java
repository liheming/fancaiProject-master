 ...
 */
public class TipsAcceptOrderDialog extends AlertDialog implements View.OnClickListener {
    ...
    public TipsAcceptOrderDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipdialog_content.setText("您确定接受订单！");
        //监听点击事件
