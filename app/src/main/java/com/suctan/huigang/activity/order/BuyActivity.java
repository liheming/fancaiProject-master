...
import com.suctan.huigang.adapter.order.buyorder.BuyFragAdapter;
import com.suctan.huigang.fragment.my.buy.MyPublishFinishOrder;
import com.suctan.huigang.fragment.my.buy.MyPublishAllOrder;
import com.suctan.huigang.fragment.my.buy.MyPublishWaitSendOrder;
import com.suctan.huigang.fragment.my.buy.MyPublishWaitOrder;
import com.suctan.huigang.fragment.my.buy.MyeatAllOrder;
import com.suctan.huigang.fragment.my.buy.MyeatFinishOrder;
import com.suctan.huigang.fragment.my.buy.MyeatWaitOrder;
import com.suctan.huigang.fragment.my.buy.MyeatWaitSendOrder;
...
public class BuyActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, InterFaceOrderState {
    ...
    private void toogleShowViewPage(int orderSortKey) {
        ...
        if (orderSortKey == 0) {
            myBuyViewpager.setVisibility(View.VISIBLE);// 设置显示哪一个ViewPager
