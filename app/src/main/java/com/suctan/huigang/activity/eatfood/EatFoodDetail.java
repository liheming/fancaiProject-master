package com.suctan.huigang.activity.eatfood;
...
import com.suctan.huigang.adapter.eatfood.EatFoodGridAdapter;
import com.suctan.huigang.adapter.eatfood.EatRecycleViewAdapter;
import com.suctan.huigang.bean.index.EatFoodBean;
import com.suctan.huigang.bean.wanteat.WantEatOtherComment;
import com.suctan.huigang.mvp.login.wanteat.WantEatPresenter;
import com.suctan.huigang.mvp.login.wanteat.WantEatView;
import com.suctan.huigang.widget.TipsAddCartDialog;
...
public class EatFoodDetail extends MvpActivity<WantEatPresenter> implements WantEatView, EatRecycleViewAdapter.OnAddCartButtonLisetner, View.OnClickListener {
    ...
    private TextView tv_foodDetails;
    ...
    private void initViewData() {
        if (mEatBean != null) {
            ...
            tv_foodDetails.setText(mEatBean.getFood_description());
        }
    }
    ...
    private void initView() {
        ...
        tv_foodDetails = (TextView) findViewById(R.id.tv_foodDetails);
