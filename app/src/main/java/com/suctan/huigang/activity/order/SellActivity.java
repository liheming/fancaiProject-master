...
import com.suctan.huigang.adapter.order.sellorder.SellFragAdapter;
import com.suctan.huigang.fragment.my.sell.SellAgreeAFrag;
import com.suctan.huigang.fragment.my.sell.SellAllAFrag;
import com.suctan.huigang.fragment.my.sell.SellAllPFrag;
import com.suctan.huigang.fragment.my.sell.SellDoingAFrag;
import com.suctan.huigang.fragment.my.sell.SellDoingPFrag;
import com.suctan.huigang.fragment.my.sell.SellFinishAFrag;
import com.suctan.huigang.fragment.my.sell.SellFinishPFrag;
...
public class SellActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, InterfaceMysellOrderState {
    ...
    private ViewPager sell_viewPageA; //接单和卖出两个viewPager
    ...
    private SegmentControl segment_sellOrder_sort;   //开关
...
//    GridView my_first_framgment_gridview;
    ...
    private void toogleShowViewPage(int sortKey) {
        ...
        if (sortKey == 0) {
            /**  设置要显示的viewPager  ，第一栏有三列 所以要隐藏待同意
             * */
    ...
    private void initFragment(int sortKey) {
        ...
        if (sortKey == 0) {
            ...
            adapter = new SellFragAdapter(getSupportFragmentManager(), mDatas); // 实例化adapter
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.llmysell_ywc:
                    tvmysell_ywc.setTextColor(select_color);
                    if (sortFrakey == 0) {
                        // TODO: 2017/5/3  修复点击文字不跳转
                        sell_viewPagep.setCurrentItem(2);
                    }
                    break;
            }
            if (sortFrakey == 1) {
