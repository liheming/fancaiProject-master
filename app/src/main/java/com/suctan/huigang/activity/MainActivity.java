...
import com.suctan.huigang.adapter.FragmentViewPage;
import com.suctan.huigang.fragment.FragmentChanel;
import com.suctan.huigang.fragment.FragmentFind;
import com.suctan.huigang.fragment.FragmentIndex;
import com.suctan.huigang.fragment.FragmentMySelft;
import com.suctan.huigang.mvp.login.index.location.LocationPresenter;
import com.suctan.huigang.mvp.login.index.location.LocationView;
 ...
 */
public class MainActivity extends MvpActivity<LocationPresenter> implements LocationView, View.OnClickListener {
        ...
        AMapLocationListener mLocationListener = new AMapLocationListener() {
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
              Map<String ,Object>  map =  new HashMap<>();
                ...
                mvpPresenter.getLocation(map);
                Log.i(TAG, "onLocationChanged: "+ Utils.getLocationStr(aMapLocation));
            }
        };
//初始化定位
...
//启动定位
    ...
    public void initView() {
        ...
        LatLng startLatlng = new LatLng(39.989612,116.480972);
        LatLng  endLatlng =  new LatLng(39.990347,116.480441);
        double juli = AMapUtils.calculateLineDistance(startLatlng, endLatlng); //来计算两点距离，单位：米。
        Log.i(TAG, "initView: 距离是多少呢"+juli);
...
//      txt_index_tipNumber = (TextView) findViewById(R.id.txt_index_tipNumber);
        ...
        if (id == 2) {
            main_fragment_viewPage.setCurrentItem(id);
            Log.i(TAG, "initView: id =" + id);
        }
