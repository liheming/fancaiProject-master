...
import com.suctan.huigang.mvp.login.my_wallet_cz.cz_walletPresenter;
import com.suctan.huigang.mvp.login.my_wallet_cz.cz_walletView;
...
public class incaseActivity extends MvpActivity<cz_walletPresenter> implements View.OnClickListener,cz_walletView {
    ...
    private void incashVariety() {
        ...
        if (TextUtils.isEmpty(money)){
            ToastTool.showToast("你还没有输入充值的数字,谢谢",2);
            return;
        }
    ...
    public void loadCourseDone() {
        ToastTool.showToast("充值成功回调 此处该跳转",1);
