...
import com.suctan.huigang.bean.address.AddAddressResult;
...
//    Observable<ModifyReturn> PubEatFood(@QueryMap Map<String, Object> needReturn);
    ...
    Observable<ModifyReturn> changeCartCountReturn(@QueryMap Map<String, Object> changCartReturn);
...
/*我要吃所有推荐*/
    ...
    Observable<ModifyReturn> BuyComfirmAOrderReturn(@QueryMap Map<String, Object> comfirmOrderReturn);
    ...
    //查看订单的评论
    @POST("cookLookCommentEatOrder")
    Observable<BuyPCommendReturn> SellCheckOrderCommentReturn(@QueryMap Map<String, Object> comfrimOrderReturn);
